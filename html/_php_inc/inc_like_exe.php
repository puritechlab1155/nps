<?php
	...
	if($ins == "Y"){
		...
		$sql_sel1 = "select ifnull(count(*), 0) cnt from km_like_ip where vol_idx = '".$vol_idx."' and board_seq='".$board_seq."' and board_sub_seq='".$board_sub_seq."'  and ip_addr='".$ip_addr."' ";
		
		$result_sel1 = mysqli_query($connect, $sql_sel1);
		$row_cnt1 = mysqli_fetch_array($result_sel1);
		$ins_yn = "N";
		...
		if($row_cnt1["cnt"] > 0){
			...
			echo(json_encode(array("like_cnt"=>$row_cnt["like_count"], "ins_yn"=>$ins_yn)));
		}
		else{
