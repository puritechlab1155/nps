...
<head>
	...
	<!-- kruddo add -->
	<?
		$vol_idx = "191";		// kruddo modify - 호차 번호. 191호가 아닌경우 변경, inc/like_share.php 에서도 변경
			...
			<div class="main_slider_wrap">
				...
				<ul class="main_slider4">
					...
					<li data-title="그곳N 그들이" class="item4 wow fadeUp">
						<a href="sub02_07.php">
							<div class="thumb">
								<span class="like_num"><em>♥</em> <?=$like_cnt_2_7;?></span>		<!-- // kruddo modify -->
			...
			<div class="inner">
				...
				<div class="thumb">
					<ul class="event_slider">
						...
						<li>
							<a href="sub03_03.php">
								<img src="../../img/vol191/main/event2_pc.jpg" alt="독자의견" class="pc">
								<img src="../../img/vol191/main/event2_m.jpg" alt="독자의견" class="mobile">
							</a>
						</li>
					</ul>
					<script>
