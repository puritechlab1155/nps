...
<head>
	...
	<!-- kruddo add -->
	<?
		$vol_idx = "195";		// kruddo modify - 호차 번호. 191호가 아닌경우 변경, inc/like_share.php 에서도 변경
		...
		<div class="main_section1 wow fadeBigInUp">
			<div class="main_slider_wrap">
				...
				<li>
						<a href="sub01_03.php">
							<div class="thumb">
								<img src="../../img/vol195/main/main_visual01.jpg" alt="NPS 쇼츠">
							</div>
							<div class="txt_group">
					...
					<li>
						<a href="sub02_01.php">
							<div class="thumb">
								<img src="../../img/vol195/main/main_visual02.jpg" alt="NPS 뉴스">
							</div>
							<div class="txt_group">
					...
					<li>
						<a href="sub02_02.php">
							<div class="thumb">
								<img src="../../img/vol195/main/main_visual03.jpg" alt="NPS쇼츠">
							</div>
							<div class="txt_group">
					...
					<li>
						<a href="sub02_03.php">
							<div class="thumb">
								<img src="../../img/vol195/main/main_visual04.jpg" alt="NPS 키워드">
							</div>
							<div class="txt_group">
					...
					<li>
						<a href="sub02_04.php">
							<div class="thumb">
								<img src="../../img/vol195/main/main_visual05.jpg" alt="NPS칼럼">
							</div>
							<div class="txt_group">
					...
					<li>
						<a href="sub04_02.php">
							<div class="thumb">
								<img src="../../img/vol195/main/main_visual06.jpg" alt="M&M 감성여행">
							</div>
							<div class="txt_group">
			...
			<li>
					<a href="/html/vol195/sub01_01.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu01.jpg" alt="북퀘스트"></div>
						<p>북퀘스트</p>
					</a>
				</li>	
			<li>
					<a href="/html/vol195/sub01_02.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu02.jpg" alt="요즘 이슈"></div>
						<p>요즘 이슈</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub01_03.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu03.jpg" alt="M&Z 일상수다"></div>
						<p>M&Z 일상수다</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub01_04.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu04.jpg" alt="힐링 레시피"></div>
						<p>힐링 레시피</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub01_05.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu05.jpg" alt="행복한 나눔"></div>
						<p>행복한 나눔</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub02_01.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu06.jpg" alt="NPS 뉴스"></div>
						<p>NPS 뉴스</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub02_02.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu07.jpg" alt="NPS 쇼츠"><i class="vod">영상</i></div>
						<p>NPS 쇼츠</p>
					</a>
				</li>
								<li>
					<a href="/html/vol195/sub02_03.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu08.jpg" alt="NPS 키워드"></div>
						<p>NPS 키워드</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub02_04.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu09.jpg" alt="NPS칼럼"></div>
						<p>NPS칼럼</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub03_01.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu10.jpg" alt="팝콘 경제"><i class="vod">영상</i></div>
						<p>팝콘 경제</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub03_02.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu11.jpg" alt="Easy선다 퀴즈"></div>
						<p>Easy선다 퀴즈</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub03_03.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu12.jpg" alt="키워드트렌드"></div>
						<p>키워드트렌드</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub04_01.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu13.jpg" alt="대한민국 테마여행"></div>
						<p>대한민국 테마여행</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub04_02.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu14.jpg" alt="오도이촌"></div>
						<p>오도이촌</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub04_03.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu15.jpg" alt="대신 일하고 올게"></div>
						<p>대신 일하고 올게</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub05_01.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu16.jpg" alt="독자 목소리"></div>
						<p>독자 목소리</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub05_02.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu17.jpg" alt="이벤트1"></div>
						<p>이벤트1</p>
					</a>
				</li>
				<li>
					<a href="/html/vol195/sub05_03.php">
						<div class="thumb"><img src="../../img/vol195/main/all_menu18.jpg" alt="이벤트2"></div>
						<p>이벤트2</p>
					</a>
				</li>
			</ul>
				   ...
				   <li data-title="북퀘스트" class="item1 wow fadeUp">
						<a href="sub01_01.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu01_01.jpg" alt="북퀘스트">
								<span class="cover like"><i></i></span>
							</div>
							<p class="txt">지금 인생이 힘겨운 당신을 위해 <br/>“인생의 터닝 포인트를 찾아라!” </p>
							<p class="tit">북퀘스트</p>							
						</a>
					</li>	
				   <li data-title="요즘 이슈" class="item1 wow fadeUp">
						<a href="sub01_02.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu01_02.jpg" alt="요즘 이슈">
								<span class="cover like"><i></i></span>
							</div>
							<p class="txt">이미 인간을 대체하고 있는 AI 일상을 <br/>파고든 인공지능의 활용법</p>
							<p class="tit">요즘 이슈</p>							
						</a>
					</li>
					<li data-title="M&Z 일상수다" class="item2 wow fadeUp">
						<a href="sub01_03.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu01_03.jpg" alt="M&Z 일상수다">
								<span class="cover like"><i></i></span>
							</div>
							<p class="txt">봄 꽃을 즐기는 N가지 방법</p>
					...
					<li data-title="힐링 레시피" class="item3 wow fadeUp">
						<a href="sub01_04.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu01_04.jpg" alt="힐링 레시피">
								<span class="cover like"><i></i></span>
								<!--<i class="vod">영상</i>-->
							</div>
							<p class="txt">싱크로율 100%, 만화영화 속 <br/>요리 따라하기</p>
					...
					<li data-title="행복한 나눔" class="item4 wow fadeUp">
						<a href="sub01_05.php">		<!-- // kruddo modify -->
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu01_05.jpg" alt="행복한 나눔">
								<span class="cover like"><i></i></span>
								<!--<i class="vod">영상</i>-->
							</div>
							<p class="txt">“재능을 나눕니다.” '기부 문화' 패러다임의 변화</p>
					...
					<li data-title="NPS뉴스" class="item1 wow fadeUp">
						<a href="sub02_01.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu02_01.jpg" alt="NPS뉴스">
					...
					<li data-title="NPS 쇼츠" class="item2 wow fadeUp">
						<a href="sub02_02.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu02_02.jpg" alt="NPS 쇼츠">
								<span class="cover fun"><i></i></span>
								<i class="vod">영상</i>
							</div>
							<p class="txt">2023년 달라지는 국민연금 제도 6가지</p>
					...
					<li data-title="NPS키워드" class="item4 wow fadeUp">
						<a href="sub02_03.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu02_03.jpg" alt="NPS키워드">
								<span class="cover fun"><i></i></span>
							</div>
					...
					<li data-title="NPS칼럼" class="item5 wow fadeUp">
						<a href="sub02_04.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu02_04.jpg" alt="NPS칼럼">
								<span class="cover fun"><i></i></span>
							</div>
							<p class="txt">연금 전문가들이 이구동성 강조하는 국민연금의 4가지 장점</p>
							<p class="tit">NPS칼럼</p>
						</a>
					</li>
				...
				<li data-title="팝콘 경제" class="item1 wow fadeUp">
						<a href="sub03_01.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu03_01.jpg" alt="팝콘 경제">
								<span class="cover good"><i></i></span>
								<i class="vod">영상</i>
							</div>
							<p class="txt">“누가 다니엘 블레이크를 죽였나” 사회 복지의 빛과 그림자</p>
							<p class="tit">팝콘 경제</p>
						</a>
					</li>
					<li data-title="Easy선다 퀴즈" class="item2 wow fadeUp">
						<a href="sub03_02.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu03_02.jpg" alt="Easy선다 퀴즈">
								<span class="cover good"><i></i></span>
							</div>
					...
					<li data-title="키워드 트렌드" class="item3 wow fadeUp">
						<a href="sub03_03.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu03_03.jpg" alt="키워드 트렌드">
								<span class="cover good"><i></i></span>
							</div>
							<p class="txt">새로운 소비 트렌드의 등장 ‘미닝아웃’</p>
				...
				<ul class="main_slider6 fixed_size">
					<li data-title="대한민국 테마여행" class="item1 wow fadeUp">
						<a href="sub04_01.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu04_01.jpg" alt="대한민국 테마여행">
								<span class="cover ok"><i></i></span>
							</div>
							<p class="txt">섬진강 따라 펼쳐지는 봄의 정취 1박 2일 구례 여행</p>
					...
					<li data-title="오도이촌" class="item2 wow fadeUp">
						<a href="sub04_02.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu04_02.jpg" alt="오도이촌">
								<span class="cover ok"><i></i></span>
							</div>
							<p class="txt">조금 더 ‘멀리’에서 만난 행복 5도 2촌 유튜버 김용성·기율</p>
							<p class="tit">오도이촌</p>
						</a>
					</li>
					<li data-title="대신 일하고 올게" class="item2 wow fadeUp">
						<a href="sub04_03.php">
							<div class="thumb">
								<span class="like_num"><em>♥</em> <?=$like_cnt_4_2;?></span>		<!-- // kruddo modify -->
								<img src="../../img/vol195/main/main_menu04_03.jpg" alt="대신 일하고 올게">
								<span class="cover ok"><i></i></span>
							</div>
							<p class="txt">“용기 없이 알맹이만 담습니다.” 제로 웨이스트 숍 알맹 상점을 가다!</p>
					...
					<li data-title="독자 목소리" class="item1 wow fadeUp">
						<a href="sub05_01.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu05_01.jpg" alt="독자 목소리">
					...
					<li data-title="이벤트1" class="item2 wow fadeUp">
						<a href="sub05_02.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu05_02.jpg" alt="이벤트1">
								<span class="cover ev"><i></i></span>
							</div>
					...
					<li data-title="이벤트2" class="item3 wow fadeUp">
						<a href="sub05_03.php">
							<div class="thumb">
								...
								<img src="../../img/vol195/main/main_menu05_03.jpg" alt="이벤트2">
								<span class="cover ev"><i></i></span>
							</div>
		...
		<div class="main_section5 wow fadeBigInUp">
			...
			<ul class="list">
				<li class="item1 wow fadeUp">
					<a href="https://www.youtube.com/watch?v=zMgEqDeehvw" target="_blank">
						<div class="thumb">
							<i class="vod">영상</i>
							<img src="../../img/vol195/main/youtube_img1.jpg" alt="#NPS #국민연금제도 #2023">
						</div>
						<dl>
							<dt>#NPS #국민연금제도 #2023</dt>
							<dd>2023년 달라지는 국민연금 제도 6가지</dd>
						</dl>
					</a>
				</li>
				<li class="item2 wow fadeUp">
					<a href="https://www.youtube.com/watch?v=JtaXy98-Jy4" target="_blank">
						<div class="thumb">
							<i class="vod">영상</i>
							<img src="../../img/vol195/main/youtube_img2.jpg" alt="연금보이스 8편">
						</div>
						<dl>
							<dt>[연금보이스 8편]</dt>
							<dd>두루누리 사회보험료 지원사업</dd>
						</dl>
					</a>
				</li>
				<li class="item3 wow fadeUp">
					<a href="https://www.youtube.com/watch?v=0bUDpDBD7-M" target="_blank">
						<div class="thumb">
							<i class="vod">영상</i>
							<img src="../../img/vol195/main/youtube_img3.jpg" alt="연금보이스 9편">
						</div>
						<dl>
							<dt>[연금보이스 9편]</dt>
							<dd>농어업인 연금보험료 지원제도</dd>
						</dl>
					</a>
				</li>
				<li class="item4 wow fadeUp">
					<a href="https://www.youtube.com/watch?v=AWenWwAQjyg&feature=youtu.be" target="_blank">
						<div class="thumb">
							<i class="vod">영상</i>
							<img src="../../img/vol195/main/youtube_img4.jpg" alt="국민연금X정훈남 콜라보">
						</div>
						<dl>
							<dt>[국민연금X정훈남 콜라보] </dt>
							<dd>미션! 2023 국민연금 레벨업</dd>
						</dl>
					</a>
				</li>
			</ul>
			...
			<div class="inner">
				...
				<div class="thumb">
					<ul class="event_slider">
						<li>
							<a href="sub05_02.php">
								<img src="../../img/vol195/main/event_pc.jpg" alt="국민연금x롯데월드 댓글 이벤트" class="pc">
								<img src="../../img/vol195/main/event_m.jpg" alt="국민연금x롯데월드 댓글 이벤트" class="mobile">
							</a>
						</li>
						<li>
							<a href="sub05_03.php">
								<img src="../../img/vol195/main/event2_pc.jpg" alt="초성퀴즈 이벤트" class="pc">
								<img src="../../img/vol195/main/event2_m.jpg" alt="초성퀴즈 이벤트" class="mobile">
							</a>
						</li>
						<li>
							<a href="sub05_01.php">
								<img src="../../img/vol195/main/event3_pc.jpg" alt="독자의견" class="pc">
								<img src="../../img/vol195/main/event3_m.jpg" alt="독자의견" class="mobile">
							</a>
						</li>
					</ul>
					<script>
