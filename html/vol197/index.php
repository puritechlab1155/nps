...
<head>
	...
	<!-- kruddo add -->
	<?
		$vol_idx = "197";		// kruddo modify - 호차 번호. 191호가 아닌경우 변경, inc/like_share.php 에서도 변경
		...
		<div class="main_section1 wow fadeBigInUp">
			<div class="main_slider_wrap">
				...
				<li>
						<a href="sub01_03.php">
							<div class="thumb">
								<img src="../../img/vol197/main/main_visual01.jpg" alt="NPS 쇼츠">
							</div>
							<div class="txt_group">
					...
					<li>
						<a href="sub02_01.php">
							<div class="thumb">
								<img src="../../img/vol197/main/main_visual02.jpg" alt="NPS 뉴스">
							</div>
							<div class="txt_group">
					...
					<li>
						<a href="sub02_02.php">
							<div class="thumb">
								<img src="../../img/vol197/main/main_visual03.jpg" alt="NPS쇼츠">
							</div>
							<div class="txt_group">
					...
					<li>
						<a href="sub02_03.php">
							<div class="thumb">
								<img src="../../img/vol197/main/main_visual04.jpg" alt="NPS 키워드">
							</div>
							<div class="txt_group">
					...
					<li>
						<a href="sub02_04.php">
							<div class="thumb">
								<img src="../../img/vol197/main/main_visual05.jpg" alt="NPS칼럼">
							</div>
							<div class="txt_group">
					...
					<li>
						<a href="sub04_02.php">
							<div class="thumb">
								<img src="../../img/vol197/main/main_visual06.jpg" alt="M&M 감성여행">
							</div>
							<div class="txt_group">
			...
			<li>
					<a href="/html/vol197/sub01_01.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu01.jpg" alt="북퀘스트"></div>
						<p>북퀘스트</p>
					</a>
				</li>	
			<li>
					<a href="/html/vol197/sub01_02.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu02.jpg" alt="요즘 이슈"></div>
						<p>요즘 이슈</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub01_03.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu03.jpg" alt="M&Z 일상수다"></div>
						<p>M&Z 일상수다</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub01_04.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu04.jpg" alt="힐링 레시피"></div>
						<p>힐링 레시피</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub01_05.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu05.jpg" alt="행복한 나눔"></div>
						<p>행복한 나눔</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub02_01.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu06.jpg" alt="NPS 뉴스"></div>
						<p>NPS 뉴스</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub02_02.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu07.jpg" alt="NPS 쇼츠"><i class="vod">영상</i></div>
						<p>NPS 쇼츠</p>
					</a>
				</li>
								<li>
					<a href="/html/vol197/sub02_03.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu08.jpg" alt="NPS 키워드"></div>
						<p>NPS 키워드</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub02_04.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu09.jpg" alt="NPS칼럼"></div>
						<p>NPS칼럼</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub03_01.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu10.jpg" alt="팝콘 경제"><i class="vod">영상</i></div>
						<p>팝콘 경제</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub03_02.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu11.jpg" alt="Easy선다 퀴즈"></div>
						<p>Easy선다 퀴즈</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub03_03.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu12.jpg" alt="키워드 트렌드"></div>
						<p>키워드 트렌드</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub04_01.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu13.jpg" alt="대한민국 테마여행"></div>
						<p>테마여행</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub04_02.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu14.jpg" alt="오도이촌"></div>
						<p>오도이촌</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub04_03.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu15.jpg" alt="대신 일하고 올게"></div>
						<p>대신 일하고 올게</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub05_01.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu16.jpg" alt="독자 목소리"></div>
						<p>독자 목소리</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub05_02.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu17.jpg" alt="이벤트1"></div>
						<p>이벤트1</p>
					</a>
				</li>
				<li>
					<a href="/html/vol197/sub05_03.php">
						<div class="thumb"><img src="../../img/vol197/main/all_menu18.jpg" alt="이벤트2"></div>
						<p>이벤트2</p>
					</a>
				</li>
			</ul>
				   ...
				   <li data-title="북퀘스트" class="item1 wow fadeUp">
						<a href="sub01_01.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu01_01.jpg" alt="북퀘스트">
								<span class="cover like"><i></i></span>
							</div>
							<p class="txt">따뜻하고 친밀한 인간관계가 주는 행복, 회복탄력성을 얻는 힘</p>
							<p class="tit">북퀘스트</p>							
						</a>
					</li>	
				   <li data-title="요즘 이슈" class="item1 wow fadeUp">
						<a href="sub01_02.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu01_02.jpg" alt="요즘 이슈">
								<span class="cover like"><i></i></span>
							</div>
							<p class="txt">관람객 63% ‘2030’… 미술관, MZ 핫플로 뜨다</p>
							<p class="tit">요즘 이슈</p>							
						</a>
					</li>
					<li data-title="M&Z 일상수다" class="item2 wow fadeUp">
						<a href="sub01_03.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu01_03.jpg" alt="M&Z 일상수다">
								<span class="cover like"><i></i></span>
							</div>
							<p class="txt">갑작스런 전화벨에 놀라는 Z VS 카톡 문자에 손가락이 지친 M</p>
					...
					<li data-title="힐링 레시피" class="item3 wow fadeUp">
						<a href="sub01_04.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu01_04.jpg" alt="힐링 레시피">
								<span class="cover like"><i></i></span>
								<!--<i class="vod">영상</i>-->
							</div>
							<p class="txt">그리운 엄마의 손맛, 나도 낼 수 있다! 영화 ‘엄마의 공책’ 속 레시피 따라하기</p>
					...
					<li data-title="행복한 나눔" class="item4 wow fadeUp">
						<a href="sub01_05.php">		<!-- // kruddo modify -->
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu01_05.jpg" alt="행복한 나눔">
								<span class="cover like"><i></i></span>
								<!--<i class="vod">영상</i>-->
							</div>
							<p class="txt">“아이들의 꿈 실현을 위한 나눔을 실천합니다!”</p>
					...
					<li data-title="NPS뉴스" class="item1 wow fadeUp">
						<a href="sub02_01.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu02_01.jpg" alt="NPS뉴스">
					...
					<li data-title="NPS 쇼츠" class="item2 wow fadeUp">
						<a href="sub02_02.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu02_02.jpg" alt="NPS 쇼츠">
								<span class="cover fun"><i></i></span>
								<i class="vod">영상</i>
							</div>
							<p class="txt">연부장, 연대리, 금주임의 국민연금 밸런스 게임</p>
					...
					<li data-title="NPS키워드" class="item4 wow fadeUp">
						<a href="sub02_03.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu02_03.jpg" alt="NPS키워드">
								<span class="cover fun"><i></i></span>
							</div>
					...
					<li data-title="NPS칼럼" class="item5 wow fadeUp">
						<a href="sub02_04.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu02_04.jpg" alt="NPS칼럼">
								<span class="cover fun"><i></i></span>
							</div>
							<p class="txt">국민연금 크레딧 제도 알고 계신가요?</p>
							<p class="tit">NPS칼럼</p>
						</a>
					</li>
				...
				<li data-title="팝콘 경제" class="item1 wow fadeUp">
						<a href="sub03_01.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu03_01.jpg" alt="팝콘 경제">
								<span class="cover good"><i></i></span>
								<i class="vod">영상</i>
							</div>
							<p class="txt">“위기에 내몰려도 도와줄 사람이 있다는 것은 좋은 거잖아요” 영화 ‘드림’</p>
							<p class="tit">팝콘 경제</p>
						</a>
					</li>
					<li data-title="Easy선다 퀴즈" class="item2 wow fadeUp">
						<a href="sub03_02.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu03_02.jpg" alt="Easy선다 퀴즈">
								<span class="cover good"><i></i></span>
							</div>
					...
					<li data-title="키워드 트렌드" class="item3 wow fadeUp">
						<a href="sub03_03.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu03_03.jpg" alt="키워드 트렌드">
								<span class="cover good"><i></i></span>
							</div>
							<p class="txt">급변하는 가족 형태가 가져올 소비 트렌드 전망</p>
				...
				<ul class="main_slider6 fixed_size">
					<li data-title="대한민국 테마여행" class="item1 wow fadeUp">
						<a href="sub04_01.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu04_01.jpg" alt="대한민국 테마여행">
								<span class="cover ok"><i></i></span>
							</div>
							<p class="txt">여수 속 뷰 맛.zip을 찾아서</p>
					...
					<li data-title="오도이촌" class="item2 wow fadeUp">
						<a href="sub04_02.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu04_02.jpg" alt="오도이촌">
								<span class="cover ok"><i></i></span>
							</div>
							<p class="txt">어른의 놀이터에서 영그는 꿈 장한별 변호사 부부의 여섯 평 농막</p>
							<p class="tit">오도이촌</p>
						</a>
					</li>
					<li data-title="대신 일하고 올게" class="item2 wow fadeUp">
						<a href="sub04_03.php">
							<div class="thumb">
								<span class="like_num"><em>♥</em> <?=$like_cnt_4_2;?></span>		<!-- // kruddo modify -->
								<img src="../../img/vol197/main/main_menu04_03.jpg" alt="대신 일하고 올게">
								<span class="cover ok"><i></i></span>
							</div>
							<p class="txt">아메리카노를 연필로 바꾸는 마법 ‘커피박 재자원화 프로젝트’</p>
					...
					<li data-title="독자 목소리" class="item1 wow fadeUp">
						<a href="sub05_01.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu05_01.jpg" alt="독자 목소리">
					...
					<li data-title="이벤트1" class="item2 wow fadeUp">
						<a href="sub05_02.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu05_02.jpg" alt="이벤트1">
								<span class="cover ev"><i></i></span>
							</div>
					...
					<li data-title="이벤트2" class="item3 wow fadeUp">
						<a href="sub05_03.php">
							<div class="thumb">
								...
								<img src="../../img/vol197/main/main_menu05_03.jpg" alt="이벤트2">
								<span class="cover ev"><i></i></span>
							</div>
		...
		<div class="main_section5 wow fadeBigInUp">
			...
			<ul class="list">
				<li class="item1 wow fadeUp">
					<a href="https://www.youtube.com/shorts/SVGFoL5ZV9c" target="_blank">
						<div class="thumb">
							<i class="vod">영상</i>
							<img src="../../img/vol197/main/youtube_img1.jpg" alt="[국민연금 밸런스 게임]">
						</div>
						<dl>
							<dt>[국민연금 밸런스 게임]</dt>
							<dd>연부장, 연대리, 금주임의 국민연금 밸런스 게임</dd>
						</dl>
					</a>
				</li>
				<li class="item2 wow fadeUp">
					<a href="https://www.youtube.com/watch?v=csuVjBQCnYs" target="_blank">
						<div class="thumb">
							<i class="vod">영상</i>
							<img src="../../img/vol197/main/youtube_img2.jpg" alt="[6년 연속 종합청렴도 우수 등급]">
						</div>
						<dl>
							<dt>[6년 연속 종합청렴도 우수 등급]</dt>
							<dd>6년 연속 종합청렴도 우수 등급 청렴 국민연금공단 🏃‍♀️🏃‍♂️</dd>
						</dl>
					</a>
				</li>
				<li class="item3 wow fadeUp">
					<a href="https://www.youtube.com/watch?v=kctTx_d9AUQ" target="_blank">
						<div class="thumb">
							<i class="vod">영상</i>
							<img src="../../img/vol197/main/youtube_img3.jpg" alt="[수어 포함]">
						</div>
						<dl>
							<dt>[수어 포함]</dt>
							<dd>프리랜서의 세금 혜택💸 국민연금</dd>
						</dl>
					</a>
				</li>
				<li class="item4 wow fadeUp">
					<a href="https://www.youtube.com/shorts/6xt_0enIatw" target="_blank">
						<div class="thumb">
							<i class="vod">영상</i>
							<img src="../../img/vol197/main/youtube_img4.jpg" alt="[국민연금 부부 수급자 최고연금액 469만 원!✨]">
						</div>
						<dl>
							<dt><!--[국민연금 수기 공모전 당선작]--></dt>
							<dd>국민연금 부부 수급자 최고연금액 469만 원!✨</dd>
						</dl>
					</a>
				</li>
			</ul>
			...
			<div class="inner">
				...
				<div class="thumb">
					<ul class="event_slider">
						<li>
							<a href="sub05_02.php">
								<img src="../../img/vol197/main/event_pc.jpg" alt="국민연금x롯데월드 댓글 이벤트" class="pc">
								<img src="../../img/vol197/main/event_m.jpg" alt="국민연금x롯데월드 댓글 이벤트" class="mobile">
							</a>
						</li>
						<li>
							<a href="sub05_03.php">
								<img src="../../img/vol197/main/event2_pc.jpg" alt="초성퀴즈 이벤트" class="pc">
								<img src="../../img/vol197/main/event2_m.jpg" alt="초성퀴즈 이벤트" class="mobile">
							</a>
						</li>
						<li>
							<a href="sub05_01.php">
								<img src="../../img/vol197/main/event3_pc.jpg" alt="독자의견" class="pc">
								<img src="../../img/vol197/main/event3_m.jpg" alt="독자의견" class="mobile">
							</a>
						</li>
					</ul>
					<script>
