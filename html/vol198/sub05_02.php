	...
	<section id="contents">
		...
		<div class="cont_block event1">
			<div class="event_header">
				<h3 class="mt80"><img src="../../img/vol198/sub/event1_img1.png" alt="MZ도 잡고 숨은 글자도 찾아라!"></h3>
				<dl>
					<dt>
			...
			<div class="event_guide">
				<div class="how_box">
					<h3>응모방법</h3>
					<div class="img">
						<img src="../../img/vol198/sub/event1_img2.png" alt="step01.내곁에 국민연금(PC,모바일)에 접속해 숨겨진 배너를 찾아 클릭,step02. 숨겨진 M, Z 글자를 찾아 단어를 조합해 이벤트 참여하기에 신청하기">
					</div>
				</div>
				...
				if ($conn->connect_error) {
					...
					$sql = "SELECT * FROM `quiz5` WHERE wip='$wip'";
				...
				<div class="hint">
					<h3>정답 힌트</h3>
					<p>
						<span>M</span> : 제한된 자원의 효용을 극대화하기 위해 알뜰하게 소비하는 전략적 소비자<br>
						<span>Z</span> : 국민연금 가입자가 질병이나 부상으로 인해 신체적·정신적 장애가 남았을 때, 줄어든<br> 소득을 보전하기 위한 연금
					</p>
                    <? 
					if($event_open_yn == "Y"){
					if($tot_rows <= 0){ ?>
                ...
                <? };} else { ?> 
					<div class="correct_input">
						<ul>
							<li>
								<p style="font-size:1.5em; color:#333;letter-spacing:1px;">* 이벤트 기간이 종료되었습니다. *</p>
							</li>
							<li>
				...
				<p class="how_txt mt30">당첨자 발표 및 경품 발송 : 2024. 01. 31. 이후</p>
			</div>
			<div class="event_goods">
				...
				<ul>
					<li>
						<dl>
							<dt>응모 기간</dt>
							<dd>2023. 11. 23. ~ 2024. 01. 31.</dd>
							<dt>당첨자 발표</dt>
							<dd>[내곁에 국민연금 웹진]<br>2023 Vol. 198호 공지 및 개별통보</dd>
						</dl>
					</li>
					<li>
						<img src="../../img/vol198/sub/event1_goods.png" alt="스타벅스 아메리카노 T">
