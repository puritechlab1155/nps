	...
	<section id="contents">
		<div class="section01 wow fadeBigInUp">
			<div class="content">
				...
				<div class="text">
					2024 <img src="img/nps_logo.svg"> 잘 읽어 보셨나요?<br>
					여러분이 읽은 웹진 속 정답이 숨어 있습니다.<br>
					빈칸을 맞추신 분들 중 추첨을 통해 선정된 15분에게<br>
					1만원 상당의 모바일 기프티콘을 드립니다.
				</div>
			</div>
		</div>
		...
		<div class="section02 wow fadeBigInUp">
			<div class="content">
				...
				<div class="button"><a class="subscribe" href="https://www.nps.or.kr/jsppage/cyber_pr/subscribe/intro.jsp" target='_blank'>구독하기</a> <a class="send" href="https://naver.me/57rKnITh" target="_blank">이벤트 참여하기</a><span class="end" href="#" >마감되었습니다</span></div>
				<div class="info">
					<ul>
