	...
	<div id="contents">
		...
		<div class="section02 wow fadeBigInUp">
			<div class="content">
				...
				<div class="subcopy">
					안녕하십니까? 국민연금 뉴스 진행을 맡은 앵커 Z입니다. 장마 전선이 전국 대부분으로 확대돼 여러모로 걱정이 많으실 것 같습니다. 올해는 작년보다 더 많은 비가 내린다는 전망처럼 매일 우중충한 날씨가 이어지고 있는데요. 장마철 풍수해와 안전사고를 대비해 차량 및 집 안팎을 반드시 점검하시길 바랍니다. 또한 고온다습한 환경으로 발생할 식중독, 곰팡이, 감염병 등을 예방하기 위해 철저히 위생 관리하시길 바랍니다. 그럼 비가 오는 하루도 산뜻하게 만들어줄 국민연금 주요 뉴스 시작합니다.
				</div>
			</div>
		</div>
