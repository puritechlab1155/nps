			...
			<div class="section05 wow fadeBigInUp">
				<div class="content">
					...
					<div class="anchor">
						<div class="img"><img src="img/sub01/sub01_04.svg"></div>
						<div class="question">
							답변 감사합니다. 보건복지부 이스란 연금정책관도 기준소득월액 상하한액 조정에 대한 말씀을 전해왔는데요.<br><br>
					...
					<div class="reporter">
						...
						<div class="graph_area">
							...
							<div class="text_box mobile_display">
								...
								<div class="text"><img src="img/sub01/check.svg"><span>대부 이자</span><em>5년 만기 국고채권 수익률과 예금은행 수신금리(신규취급액 기준) 중 낮은 금리로 분기별 변동</em></div>
