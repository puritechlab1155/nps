	...
	<section id="contents">
		...
		<div class="section02 wow fadeBigInUp">
			<div class="content">
				...
				<div class="not_box">본 기사는 2024년 7월 9일 기준으로 작성됐습니다. 기사를 접하는 날짜에 따라 기사 내 기재된 정책 진행 여부가 다를 것이오니, 이점 고려하시어 봐주시기 바랍니다.</div>
			</div>
		</div>
		...
		<div class="section04 wow fadeBigInUp">
			<div class="content">
				...
				<ul>
					<li>
						<div class="img_box"><img src="img/sub04/sub04_09.svg"></div>
						<span>임신·출산진료비지원사업(임신 바우처)</span>
						<p>
							임신·출산진료비지원사업은 의료급여 수급권자 중 임신 중이거나 출산(유산 및 사산 포함)한 임산부 및 출생 후 2세 미만의 자녀를 대상으로 단태아 100만 원, 다태아 140만 원(분만 취약 지역은 20만 원 추가)을 지원하는 제도입니다. 임신을 확인한 임산부는 국가에서 지급하는 국민행복카드를 발급받아 임신 바우처로 적립된 포인트를 임신·출산에 관한 진료 및 약제 구입에 대한 본인 부담금(급여·비급여 비용) 또는 2세 미만 영유아의 진료 및 처방된 약제·치료 재료 구입에 대한 본인 부담금(급여·비급여 비용) 결제에 사용할 수 있습니다.
						</p>
					</li>
					<li>
					...
					<li>
						...
						<span>부모 급여</span>
						<p>
							2024년 1월부터 부모 급여도 인상됐습니다. 0세(0~11개월)는 월 70만 원에서 100만 원, 1세(12~23개월)는 35만 원에서 50만 원을 받을 수 있습니다. 어린이집을 이용한다면 부모 급여를 보육료 바우처로 지원받게 되며, 어린이집 이용료 결제에 사용되는 보육료 바우처가 부모 급여보다 적은 경우에는 신청한 계좌로 차액을 받게 됩니다. 예를 들어 어린이집을 이용하는 0세 아동은 부모 급여 100만 원을 지원받는데요. 그중 어린이집 보육료가 54만 원이라면, 100만 원의 지원금 중 54만 원은 아이행복카드를 활용해 보육료 바우처로, 나머지 차액인 46만 원은 현금으로 받게 됩니다.
						</p>
					</li>
				</ul>
			</div>
