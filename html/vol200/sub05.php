		...
		<div class="section10 wow fadeBigInUp">
			<div class="content">
				...
				<div class="text fadeBigInUp">
					...
					고창고인돌박물관에서 도보로 약 600m, 또는 탐방열차를 타고 이동하면 고인돌유적과 함께 죽림선사마을이 나타난다. 수천 년 세월을 품은 다채로운 모양의 고인돌이 싱그러운 녹음을 배경으로 세워진 모습이 인상적이다. 죽림선사마을에서는 반달돌칼과 돌화살촉을 비롯해 고창의 관광 캐릭터인 모로모로를 활용한 열쇠고리 만들기 등 색다른 체험도 가능하다.
				</div>
				<div class="slider_wrap">
					<ul class="slider7">
