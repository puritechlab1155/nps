	...
	<section id="contents">
		...
		<div class="section03 wow fadeBigInUp">
			<div class="content">
				...
				<div class="text fadeBigInUp">
					...
					선운사는 지장보살 신앙의 성지로 꼽히는데, 여기에 모셔진 금동지장보살좌상에는 믿지 못할 이야기가 전해진다. 일제강점기에 일본으로 밀반출됐던 금동지장보살좌상이 주인이 바뀔 때마다 꿈에 나타나 “나는 본래 고창 도솔산에 있었으니 그리로 보내 달라”며 크게 꾸짖었던 것. 심지어 이 불상을 소지한 이들에게 연달아 불행이 닥치자 결국 마지막 소장자가 고창경찰서에 신고해 반환했다고 한다. 주민들은 우여곡절 끝에 2년 만에 원래의 자리로 돌아온 금동지장보살좌상을 가장 아끼고 섬긴다. 선운사에는 보물로 지정된 금동지장보살좌상과 대웅보전, 천연기념물인 동백숲 등 다양한 국가유산을 보유하고 있다.<br>
				...
				<div class="info_area">
					<div class="info_box">
						...
						<div class="info_list">
							...
							<div class="list"><span><img src="img/sub05/sub05_icon2.svg">주&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;소</span><em>전북 고창군 아산면 선운사로<br class="mobile_display"> 250</em></div>
				...
				<div class="info_area">
					<div class="info_box">
						...
						<div class="info_list">
							...
							<div class="list"><span><img src="img/sub05/sub05_icon5.svg">이용요금</span><em>1인 8천 원 또는 책 구입 시 무료 입장</em></div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="section07 wow fadeBigInUp">
			<div class="content">
				...
				<div class="text fadeBigInUp">
					복분자는 고창하면 빼놓을 수 없는 특산품이다. 
					예부터 자양강장 효과가 뛰어난 열매로 꼽혔던 복분자는 차와 술은 물론 다양한 제품으로 생산·판매 중이다. 
					고창에서는 이 같은 복분자 관련 산업을 지원하고 활성화하기 위해 지난 2014년 테마단지를 조성했다. 
					복분자 농공단지와 연구소, 식품업체들이 입주했고 주민들을 위한 유원지도 조성됐다. 
					드넓은 공원에는 복분자를 주제로 한 조형물과 감성적인 포토존, 반려견 놀이터, 미니 동물원 등이 자리한다. 
					특히 복분자 모양의 펜션이 눈길을 사로잡는 국민여가캠핑장은 올해 열린관광지로 선정되어 모두가 장애물 없이 캠핑의 낭만을 즐길 수 있는 공간으로 변신을 앞두고 있다. 
					현재는 카라반과 오토캠핑장, 텐트사이트를 이용할 수 있다.
				</div>
				<div class="slider_wrap">
					<ul class="slider5">
