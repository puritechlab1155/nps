			...
			<div class="content">
				...
				<div class="content02 fadeBigInUp">
					...
					<div class="text">옥수수를 이야기하는데 뜬금없이 멕시코가 나온다고 생각할 수 있지만, 옥수수와 멕시코는 떼려야 뗄 수 없는 관계다. 옥수수의 최초 탄생이 멕시코와 연결돼 있기 때문이다. <br>
						...
						<div class="note">
							<span>옥수수 도둑</span>
							옛날 옛적 멕시코의 넓은 옥수수 밭을 가진 늙은 아버지가 있었다. 이 아버지에게는 아들 셋이 있었는데, 첫째는 게으름뱅이에 잠꾸러기, 둘째는 심술쟁이, 셋째는 성실한 아이였다. 어느 해 옥수수 밭에 도둑이 들었고, 아버지는 도둑을 잡는 아들에게 재산을 물려준다고 선언한다. 첫째가 의기양양하게 옥수수 밭으로 가지만, 토르티야를 먹고 잠이 든다. 그때 개구리가 나타나 자신을 데려가 주면 도둑을 잡게 해 준다고 부탁한다. 기분 좋게 잠을 자던 첫째는 짜증나서 개구리를 우물에 던지고 다시 잠이 든다. 날이 밝았을 땐 이미 옥수수는 없어졌고, 도둑을 잡지 못한 첫째는 터덜터덜 집으로 돌아온다. 둘째 역시 개구리를 우물에 던져 버리고 옥수수 밭 도둑을 기다린다. 그때 큰 새가 옥수수를 쪼아먹는 것을 보고 총을 쏘지만, 총알이 빗나간다. 셋째는 개구리의 부탁을 들어주고 개구리와 함께 옥수수 밭으로 향한다. 개구리는 도중에 만난 우물 앞에서 셋째에게 소원을 빌어 보라 한다. “옥수수 밭 도둑을 잡게 해 주시고, 아름다운 아가씨를 배필로 얻게 해 주시고, 커다란 집에서 살게 해 주세요.” 셋째가 옥수수 밭을 지킬 때 큰 새가 다시 날아와 옥수수를 훔쳐 먹는다. 개구리는 새에게 총을 겨누는 셋째를 말리며 울기 시작한다. 그때 새가 아름다운 여인으로 변한다. 셋째는 여인에게 결혼을 요청하고 여인, 개구리와 집으로 돌아간다.
						</div>
