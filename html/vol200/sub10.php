...
<!-- TODO br처리에 pc, mobile을 나눈다 -->
				...
				<div class="info">
					<ul>
						<li><img src="img/info_bullet.svg">본 이벤트 경품은 당사 사정에 따라 변경될 수 있습니다.</li><br>
						<li><img src="img/info_bullet.svg">이벤트 응모 시 개인정보 활용에 동의한 것으로 간주됩니다.</li><br>
						<li><img src="img/info_bullet.svg">부정행위를 통해 이벤트 참여 시 제재를 받으며, 당첨 경품도 취소됩니다.</li><br>
						<li><img src="img/info_bullet.svg">많은 분들께 이벤트 혜택을 드리기 위해 중복 당첨 시 경품 지급은 한 번만 이뤄집니다.</li><br>
						<li><img src="img/info_bullet.svg">당첨자에 한해 개인정보가 경품 발송 대행사에 전달되며 경품 발송 후 즉시 폐기됩니다.</li><br>
						<li><img src="img/info_bullet.svg">정확하지 않은 개인정보로 인해 당첨자 연락이 되지 않거나 확인이 불가능할 경우, 당첨 취소됩니다.</li>
					</ul>
				</div>
			</div>
		</div>
