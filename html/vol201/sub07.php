...
<div id="wrap" class="sub07">
	...
	<section id="contents">
		...
		<div class="section02 wow fadeBigInUp">
			<div class="content">
					<div class="subtitle_top">은퇴 후의 삶을 준비하는 우리들의 자세</div>
					...
					<div class="subcopy">
						최근 ‘마처 세대’라는 단어가 이슈이다. 베이비붐 세대(1955년~1963년)와 1960년대생을 포함하는 말로, 부모를 부양하는 ‘마’지막 세대이자 자녀에게서 부양받지 못하는 ‘처’음 세대라는 뜻이다. 부모 부양과 보답 없는 자녀 투자, 이 둘은 결국 ‘마처 세대’가 부담해야 하는 비용이다. 그 비용은 과거의 통상적인 수준이 아니다. 부모 세대의 장수로 인해 부양 기간이 길어지고 높은 교육비와 낮은 취업률로 인해 자녀에 드는 비용도 증가했다. 거동이 불편한 부모의 경우 요양사 비용이 한 달 300~400만 원에 이른다. ‘마처 세대’에게 스스로 노후를 ‘잘’ 준비할 방법 세 가지를 추천한다.
					</div>
			</div>
		</div>
		...
		<div class="section03 wow fadeBigInUp">
			<div class="content">
				...
				<div class="text fadeBigInUp">
					...
					노동시장에 오래 머무르면 자산을 넉넉하게 관리할 수 있다. 60세의 A와 B가 있다. 이들은 5억 원의 금융자산을 갖고 있고 생활비로 매년 4천만 원을 지출한다. A는 5억 원을 4% 수익률로 운용해서 불리며, 노동시장에서 근로소득을 얻어 생활비를 충당했다. B는 다른 소득이 없어서 금융자산에서 매년 생활비 4천만 원을 인출했다. 10년이 지난 70세에 이들의 자산은 어떻게 되어 있을까? A는 2억 4,000만 원이 불어나 7억 4,000만 원의 자산을 갖게 됐지만, B는 2억 원이 남았다. 60세에 출발점이 같았지만, 70세에 이르러서는 차이가 벌어진 셈이다.<br>
		...
		<div class="section04 wow fadeBigInUp">
			<div class="content">
				...
				<div class="text fadeBigInUp">
					...
					수익률 순서 리스크는 은퇴 후 투자수익률 순서에 따라 노후 자금이 고갈되는 시기가 달라질 수 있는 위험을 말한다. 투자수익률이 3년 동안 (+27%, +7%, -13%)인 A와 (-13%, +7%, +27%)인 B가 있다고 하자. 연 투자수익률은 5.7%로 같지만, 수익률 순서가 다르다. A와 B 모두 1억 원을 가지고 있고 매년 2천만 원을 사용한다고 예를 들어 보자. A의 경우 1억 원을 가지고 있는 첫해의 수익률이 +27%로 높고, 매년 2천만 원을 빼서 사용한 후의 3년째 투자수익률이 –13%로 낮은 경우 3년 뒤에 6,220만 원이 남는다. 반면, B는 1억원을 갖고 있는 첫해의 초기 수익률이 –13%로 낮고, 매년 2천만 원을 빼서 사용한 후의 3년째 투자수익률이 +27%로 높아 3년 뒤에 4,560만 원이 남는다. 초기에 수익률이 좋은 게 유리함을 볼 수 있다.<br>
					이유는 간단하다. 돈을 사용하면 자산은 계속 줄어들므로 자산을 가장 많이 확보한 투자 초기에 수익률이 높은 게 유리하기 때문이다.<br>
					이 세 가지 리스크를 모두 견고하게 방어하는 게 국민연금이다. 국민연금은 물가에 연동하여 연금액을 조정하고, 죽을 때까지 지급하며, 주식시장 급락 여부와 관계없이 약정한 연금액을 지급하기 때문이다. 참고로 세 가지 리스크를 모두 방어하는 민간 금융상품은 없다.
				</div>
		...
		<div class="section05 wow fadeBigInUp">
			<div class="content">
				...
				<br class="pc_display">
				<div class="text fadeBigInUp">
					세 가지 리스크에 대비하면서 은퇴소득을 만들려면 종신연금, 계좌인출, 투자와 연금이 혼합된 하이브리드 상품군을 잘 섞을 필요가 있다. 종신연금에는 국민연금 등의 공적연금, 주택연금, 민간의 종신연금이 있다. 계좌인출에는 채권, 월 분배형 펀드, 인컴 펀드 등이 있으며, 하이브리드는 최저분배금이 보장되는 변액연금이 있다. 자산 축적 때는 주식, 채권, 부동산을 적절히 섞어 효율적으로 자산을 배분해야 하고, 노후에 인출을 통해 은퇴소득을 만들 때는 세 가지 인출상품군을 잘 섞는 방식으로 상품을 배분하기를 바란다.<br>
					상품배분 이외에 주의할 한 가지가 있다. 은퇴소득의 시간에 따른 배치 문제이다. 채권 등 계좌인출 은퇴소득은 노후 전반기에 배치하고 종신연금은 노후 후반기에 배치하는 게 좋다. 80세 이후에는 언제까지 살지 모를 수명 불확실성뿐만 아니라 인지증(치매) 등으로 자산관리가 어렵기에 자동으로 은퇴소득이 나와야 한다. 국민연금, 주택연금, 민간의 종신연금 등의 수령 시기를 늦추는 게 좋은 이유이다. 이미 서구에서는 종신연금의 수령을 80세 이후로 늦추는 장수연금의 필요성을 강조하고 있다.<br>
					60대에 노동시장에 머무르기, 세 가지 리스크 파악하기, 선(先)계좌 후(後)연금을 생각하며 노후 준비를 하면 ‘마처 세대’도 능히 불확실한 노후에 대비할 수 있을 것이다.
				</div>
			</div>
		</div>
