	...
	<section id="contents">
		<div class="section01 wow fadeBigInUp">
			<div class="content">
				...
				<div class="text">
					독자 여러분이 남겨 주신 다양한 의견을 소개합니다. 국민연금 가을호 웹진에 대한 리뷰, <br class="pc_display">국민연금 제도에 대한 희망이 담긴 조언, 기대감 등 독자 여러분의 목소리를 기다리고 있겠습니다. 늘 관심을 갖고 웹진을 아껴 주시는 독자 여러분께 감사의 말씀을 전합니다.
				</div>
				<div class="date_area">
				...
				<div class="button"><a class="subscribe" href="https://www.nps.or.kr/jsppage/cyber_pr/subscribe/intro.jsp" target='_blank'>구독하기</a><a class="send" href="https://naver.me/xiqcrOqt" target="_blank">의견 보내기</a><span class="end" href="#" >마감되었습니다</span></div>
				<div class="info">
					<ul>
