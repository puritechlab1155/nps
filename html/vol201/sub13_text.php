...
<!-- 이벤트 참여 상태에 따른 팝업 -->
    ...
    <div class="popUp result_modal04" >
        <div class="modal">
            <div class="content">
                <p>이미 응모하셨습니다.</p>
                <div class="button" onclick="closeModal()">확인</div>
            </div>
        </div>
    </div>
    ...
    <div class="popUp result_modal01" style="display:none;">
        <div class="modal">
            <div class="content">
                ...
                <div class="button" onclick="closeModal()">클릭!</div>
            </div>
        </div>
    </div>
    ...
    <div class="popUp result_modal04" style="display:none;">
        <div class="modal">
            <div class="content">
                ...
                <div class="button" onclick="boom_submit(); closeModal();">확인</div>
            </div>
        </div>
    </div>
    ...
    <div class="popUp result_modal04" style="display:none;">
        <div class="modal">
            <div class="content">
                ...
                <div class="button" onclick="closeModal()">닫기</div>
            </div>
        </div>
    </div>
