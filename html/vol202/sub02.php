...
<div id="wrap" class="sub02">
	...
	<section id="contents">
		...
		<div class="section03 wow fadeBigInUp">
			<div class="content">
				<div class="subtitle">연금개혁에 대한 세대별 불만</div>
				<br class="pc_display">
				<div class="text">
					연금개혁, 특히 전 국민이 의무적으로 가입하는 국민연금과 관련해 취재하다 보면 세대별 반응은 극명히 갈린다. 청년층에서는 “기금이 고갈돼 받지도 못할 것”이라는 불신이 팽배하고 “이득은 기성세대가 독차지하고 부담만 큰데 없애고 말자”는 극단적 반발도 적지 않다. 노년층은 또 그들대로 “쥐꼬리 만한 연금만으로 노후 생활은 불가능하다”며 고개를 젓는다. <br>
		...
		<div class="section05 wow fadeBigInUp">
			<div class="content">
				<div class="subtitle">정부가 발표한 연금 개혁안의 최대 쟁점은?</div>
				<br class="pc_display">
				<div class="text">
					정부는 9월 초 보험료율 13%와 소득대체율 42% 등 모수개혁안이 중심인 ‘연금개혁 추진계획’을 제시했다. 무려 21년 만에 정부가 내놓은 단일 개혁안이다. 21대 국회 연금특위 공론화위원회의 결론과는 격차가 큰 소득대체율, 구조개혁을 의식해 포함한 듯한 연금액 ‘자동조정장치’ 등에 대한 비판이 이어지지만 일단 치열하게 연금개혁을 논의할 판은 깔렸다. <br>
				...
				<div class="img_box wow fadeBigInUp"><img src="img/sub02/sub02_02.jpg"></div>
			</div>
		</div><!-- //.section05 -->

		<div class="section06 wow fadeBigInUp">
			<div class="content">
				<div class="subtitle">연금개혁 과정에도 필요한 긍정적 사고</div>
				<br class="pc_display">
				<div class="text">
					온라인에서 젊은 세대를 중심으로 유행한 ‘럭키 비키’가 산업계, 공공부문 등 전방위로 확산하는 분위기다. 그룹 아이브 멤버 장원영의 영어 이름 비키(Vicky)와 행운을 뜻하는 럭키(Lucky)를 합친 럭키 비키는 부정적인 일조차 자신에게 도움이 되는 과정으로 여기는 긍정적 사고가 가동될 때 따라붙는 감탄사다. <br>
					연금개혁 과정에도 럭키 비키가 작동할 수 있다면 어떨까. 기성세대는 보험료율 인상이 부담스럽겠지만 청년세대보다 상대적으로 덜 내고 더 받는 사실은 부인할 수 없다. 은퇴하기 전까지 보험료를 조금 더 납부해서 미래를 살아갈 자녀들의 짐을 덜어줄 수 있다면 럭키 비키로 받아들일 수 있다. 청년들도 연금이 제 기능을 해 나중에 부모의 노후를 챙겨야 할 부담이 줄어든다면 그 또한 럭키 비키 아닌가. 정부도 연금에 재정 투자를 늘려서 노후의 보편적 삶이 개선된다면 다른 사회복지제도에 들어갈 비용을 줄이는 효과를 기대할 수 있다. <br>
