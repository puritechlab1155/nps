					...
					<div class="item_box">
						<ul>
							<li class="item01">
								<span>Q 1</span>
								<p>
									실업 크레딧은 구직급여 수급자가 연금보험료의 납부를 희망하고 본인 부담분 연금보험료(25%)를 납부하는 경우, 국가에서 보험료(75%)를 지원하고 그 기간을 최대 12개월까지 가입기간으로 추가 산입하는 제도이다.
								</p>
								<div class="ox_box">
							...
							<li class="item02">
								<span>Q 2</span>
								<p>
									국민연금 2024년 상반기 기금 운용수익률이 9.71%를 돌파했다.
								</p>
								<div class="ox_box">
									<div class="blue">O</div>
									<div class="line"></div>
